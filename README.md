...
Make sure your requirements.txt file contains necessary packages (e.g., Flask, OpenCV, NumPy). Then run:
...
Navigate to http://127.0.0.1:5000 to view the dashboard, upload a thermal image, and see the fault detection results along with the 
analysis metrics.
